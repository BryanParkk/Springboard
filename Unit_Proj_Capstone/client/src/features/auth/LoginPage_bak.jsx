      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <h1 className="headline">
            ...
            <i>& Level Up Your Fitness</i>
          </h1>
          <p className="sub">
            Your goals, our mission — start your journey today.
          </p>
          ...
          <div className="cta-row">
            <p className="signup-msg">
              <Link
                to={`/signup?postLoginPath=${encodeURIComponent(
                  postLoginPath
                )}`}
          ...
          <ul className="usp">
            ...
            <li>
              <span className="badge">Community Challenges</span>
            </li>
          </ul>
        </div>
      </section>
