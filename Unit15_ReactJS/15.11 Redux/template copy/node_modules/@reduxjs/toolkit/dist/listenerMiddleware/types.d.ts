import type { PayloadAction, BaseActionCreator } from '../../../../../../template/node_modules/@reduxjs/toolkit/dist/createAction';
import type { Dispatch as ReduxDispatch, AnyAction, MiddlewareAPI, Middleware, Action as ReduxAction } from 'redux';
import type { ThunkDispatch } from 'redux-thunk';
import type { TaskAbortError } from '../../../../../../template/node_modules/@reduxjs/toolkit/dist/listenerMiddleware/exceptions';
/**
 * @internal
...
export interface TakePattern<State> {
    ...
    <Predicate extends AnyListenerPredicate<State>>(predicate: Predicate, timeout?: number | undefined): Promise<[AnyAction, State, State] | null>;
}
/** @public */
